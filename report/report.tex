...
\section{Francesca Gatti}
\begin{itemize}
    \item \textbf{Utilizzo lambda expression} 
...
\textbf{Sviluppi futuri}: aggiunta di nuovi bottoni alla schermata del menù (per esempio un LEVEL4). Creazione di un negozio più 
rifornito con più skin acquistabili. Implementazione di un sistema di punteggio basato, oltre che sulle monete, sulla quantità di tempo impiegato
per completare il livello. Aggiungere monete di grandezze diverse con valore maggiore rispetto a quelle già presenti, in modo da avvicinarsi di 
più al vero gioco Super Mario Bros.
\textbf{Autovalutazione}: 
